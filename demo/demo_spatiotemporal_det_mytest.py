...
def parse_args():
    ...
    parser.add_argument(
        '--checkpoint',
        default=('/home/hjj/wuyini_pro/mmaction2/Checkpoints/mmaction/slowonly_omnisource_pretrained_r101_8x8x1_20e_ava_rgb_20201217-16378594.pth'),
        help='spatio temporal detection checkpoint file/url')
    parser.add_argument(
        '--det-config',
        default='/home/hjj/wuyini_pro/mmaction2/demo/faster_rcnn_r50_fpn_2x_coco.py',
        help='human detection config file path (from mmdet)')
    parser.add_argument(
        '--det-checkpoint',
        default=('/home/hjj/wuyini_pro/mmaction2/Checkpoints/mmdetection/faster_rcnn_r50_fpn_2x_coco_bbox_mAP-0.384_20200504_210434-a5d8aa15.pth'),
    ...
    parser.add_argument(
        '--label-map',
        default='/home/hjj/wuyini_pro/mmaction2/tools/data/ava/label_map.txt',
        help='label map file')
    parser.add_argument(
        '--device', type=str, default='cuda:0', help='CPU/CUDA device option')
    parser.add_argument(
        '--out-filename',
        default='demo/det_result/wyn_det.mp4',
