...
from .bbox_head_titan import BBoxHeadTITAN
...
from .roi_head import AVARoIHead,TITANRoIHead,TITANRoIHead_CFAM #这个是只在baseline的基础上加了一个cfam模块,
